...
pub struct CpalAudioRecorder {
    ...
    permission: Arc<dyn MicrophonePermissionProvider>,
}
...
impl CpalAudioRecorder {
    ...
    pub fn with_preferred_input_device_id(preferred_input_device_id: Option<String>) -> Self {
        Self::new(
            Arc::new(crate::MacOsMicrophonePermission),
            preferred_input_device_id,
        )
    }
    ...
    pub fn prepare(&mut self) -> Result<(), RecordingError> {
        ...
        if self.permission.authorization() != MicrophoneAuthorization::Granted {
...
impl AudioRecorder for CpalAudioRecorder {
    ...
    fn set_preferred_input_device_id(&mut self, id: Option<String>) {
        Self::set_preferred_input_device_id(self, id);
    }
