...
use template_infra::{
    VerifiedModelInstaller, WhisperSpeechRecognizer, current_process_resident_memory_bytes,
};
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let model = probe_support::install_model("Whisper", &installer, 50 * 1024 * 1024)?;
